...
echo ---- Building image ---- 
docker build --rm -t kserve-autogl:${version} .

echo ---- Pushing to docker hub ----
# replace "skirpichenko" with "tigergraphml"
DOCKER_USER=skirpichenko
docker tag kserve-autogl:${version} ${DOCKER_USER}/kserve-autogl:${version}
docker push ${DOCKER_USER}/kserve-autogl:${version}
